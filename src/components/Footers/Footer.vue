      ...
      <div class="flex flex-wrap text-center lg:text-left">
        <div class="w-full lg:w-6/12 px-4">
          ...
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Alamat: Gedung Menara Global
          </h5>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Jl. Jend. Gatot Subroto Kav. 27 Lt. 15
          </h5>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Jakarta - Selatan
          </h5>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Telp: 021-52920911-12,
          </h5>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Mobile/WhatsApp: 081310511397,
          </h5>
          <h5 class="text-lg mt-0 mb-2 text-gray-700">
            Email: bpalma_cemerlang@yahoo.com
          </h5>
        </div>
        <div class="w-full lg:w-6/12 px-4">
      ...
      >
        <div class="w-full md:w-4/12 px-4 mx-auto text-center">
          <div class="text-sm text-gray-600 font-semibold py-1">
            Copyright © {{ date }} PT. Blesindo Palma Cemerlang
          </div>
        </div>
      </div>
    </div>
